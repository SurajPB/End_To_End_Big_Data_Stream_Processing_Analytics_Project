...
lazy val schemaRegistrar = (project in file("schema-registrar"))
  ...
  .settings(
    ...
    resolvers += "Hortonworks Nexus" at "https://repo.hortonworks.com/content/groups/public/",
	resolvers ++= Seq(
    "Nexus aliyun" at "http://maven.aliyun.com/nexus/content/groups/public",
    "Nexus hortonworks Repository" at "https://repo.hortonworks.com/content/groups/public/"),
